...
def printNsave_timewise(pops,t):
    '''Creates and plots a graph of the consumer and ressources timewise trajectories in a figure that is then saved in result'''
    fig = plt.figure()
    ...
    fig.savefig('../result/LV_model.pdf')

def printNsave_phasewise(pops):
    '''Creates and plots a graph of the consumer and ressources phasewise trajectories in a figure that is then saved in result'''
    fig = plt.figure()
    ...
    plt.show()# To display the figure
    fig.savefig('../result/LV_model2.pdf')
